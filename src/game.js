...
export const CHANCE = [
  ...
  { text: "Advance to the nearest Railroad. Pay double rent if owned.", nearest: "railroad" },
  { text: "Advance to the nearest Railroad. Pay double rent if owned.", nearest: "railroad" },
  { text: "Advance to the nearest Utility. If owned, pay 10 times the dice roll.", nearest: "utility" },
  ...
  { text: "Take a walk on the Boardwalk.", move: 39 },
  { text: "Elected Chairman of the Board. Pay each player $50.", payEach: 50 },
  { text: "Your building and loan matures. Collect $150.", money: 150 },
];
...
export const CHEST = [
  ...
  { text: "Get Out of Jail Free. Keep this card until needed or traded.", getOutOfJail: true },
  { text: "Go directly to Jail.", jail: true },
  { text: "Grand Opera Night. Collect $50 from every player.", collectEach: 50 },
  { text: "Holiday fund matures. Receive $100.", money: 100 },
  { text: "Income tax refund. Collect $20.", money: 20 },
  { text: "It is your birthday. Collect $10 from every player.", collectEach: 10 },
  { text: "Life insurance matures. Collect $100.", money: 100 },
  { text: "Hospital fees. Pay $50.", money: -50 },
  { text: "School fees. Pay $50.", money: -50 },
  { text: "Receive consultancy fee. Collect $25.", money: 25 },
  { text: "You are assessed for street repairs. Pay $40 per house and $115 per hotel.", repairs: { house: 40, hotel: 115 } },
  { text: "You have won second prize in a beauty contest. Collect $10.", money: 10 },
];
